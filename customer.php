...
<header class="header">
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                <a class="editBtn" href="?edit=<?php echo urlencode($row['customer_id']); ?>">Edit</a>
                <a class="deleteBtn" href="?delete=<?php echo urlencode($row['customer_id']); ?>" onclick="return confirm('Are you sure?');">Delete</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
