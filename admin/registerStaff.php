            ...
            <div class="staff-list">
                ...
                <div class="table-controls">
                    <form class="form-controls" method="GET" action="registerStaff.php">
                        <a href="registerStaff.php" class="refresh-Btn"><i class="fas fa-sync-alt"></i></a>
                        ...
                        <?php if (!empty($staffAccounts)): ?>
                            <?php foreach ($staffAccounts as $staff): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="editBtn" href="?edit=<?php echo htmlspecialchars($staff['customer_id']); ?>"><i class="fas fa-edit"></i></a>
                                        <a class="deleteBtn" href="?delete=<?php echo htmlspecialchars($staff['customer_id']); ?>" onclick="return confirm('Are you sure?');"><i class="fas fa-trash-alt"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
